...
#' @param population Choose population from "all", white", "black", "asian", "mixed", or "other".
...
#' @param output Name of comorbidity association test result file to be outputted.
