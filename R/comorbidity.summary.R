...
#' @return Outputs comorbidity summary file.
#' @export comorbidity.summary
#' @examples
#' comorbidity.summary(hesin.file, hesin_diag.file, cov.file, ICD10.file, primary = F, Date.end="16/03/2020")

### comorbidity
comorbidity.summary <- function(hesin.file, hesin_diag.file, cov.file, primary=FALSE, ICD10.file="./data/ICD10.coding19.tsv", Date.start=NULL, Date.end=NULL){
