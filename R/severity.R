...
#' @param out.name Name of severity files to be outputted.
...
severity.summary <- function(res.eng, res.wal=NULL, res.sco=NULL, death.file, death.cause.file, hesin.file, hesin_diag.file, hesin_oper.file, hesin_critical.file, code.file="./data/coding240.tsv", Date=NULL, out.name=NULL){
