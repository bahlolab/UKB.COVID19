...
comorbidity.asso <- function(res.file, cormorbidity.file, covars=c("sex","age","bmi"), phe.name, output=NULL){
  ...
  if(is.null(output)) output <- paste0(phe.name, "_comorbidity_asso.csv")
